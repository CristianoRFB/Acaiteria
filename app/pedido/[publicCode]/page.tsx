...
interface PublicOrder { orderNumber: string; createdAt?: string; items: PricedItem[]; pricing: { totalCents: number }; fulfillment: { mode: 'PICKUP' | 'DELIVERY' }; status: OrderStatus; updatedAt?: string }
