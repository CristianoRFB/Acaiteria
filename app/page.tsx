...
function ProductCard({ product, category }: { product: Product; category: ProductCategory }) {
  ...
  return <a href={`/montar/${product.id}`} className="group grid min-h-48 min-w-0 grid-cols-[minmax(0,1fr)_88px] overflow-hidden rounded-[28px] border border-[#82204f]/10 bg-white p-4 shadow-[0_12px_40px_rgba(88,32,58,.07)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_45px_rgba(88,32,58,.12)] min-[420px]:grid-cols-[minmax(0,1fr)_112px] sm:grid-cols-[minmax(0,1fr)_150px] sm:p-5">
