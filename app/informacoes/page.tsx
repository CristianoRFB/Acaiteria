    ...
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      ...
      <section className="mt-4 rounded-[28px] bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          <a href="/menu/combinados.webp" target="_blank" rel="noreferrer" className="group overflow-hidden rounded-[22px] border border-[#82204f]/10 bg-[#fff0f5]"><img loading="lazy" src="/menu/combinados.webp" alt="Cardápio original de combinados" className="aspect-[4/3] w-full object-cover object-top transition group-hover:scale-[1.02]" /><strong className="block p-4 text-sm text-[#82204f]">Abrir combinados</strong></a>
          <a href="/menu/cardapio-completo.webp" target="_blank" rel="noreferrer" className="group overflow-hidden rounded-[22px] border border-[#82204f]/10 bg-[#fff0f5]"><img loading="lazy" src="/menu/cardapio-completo.webp" alt="Cardápio original de copos, acompanhamentos, milk-shakes, sorvetes, bebidas, shakes e salada de frutas" className="aspect-[4/3] w-full object-cover object-top transition group-hover:scale-[1.02]" /><strong className="block p-4 text-sm text-[#82204f]">Abrir cardápio completo</strong></a>
        </div>
      </section>
